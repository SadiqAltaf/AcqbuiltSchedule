    ...
    <form id="form1" runat="server">
        <div>
            <div class="jombotron text-center">
                ...
                <h1> ACQBUILT SCHEDULE</h1>
                <p> Select Master Schedule or Crane Schedule button below</p>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class ="col-sm-4">
                        <p>
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Master Schedule" />
                        </p>
                        <p> Master Schedule contains the crane lift and Cap Date with Job Address</p>
                    </div>
                    <div class ="col-sm-4">
                        <p>
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Production Schedule" />
                        </p>
                        <p> Production Schedule contains Schedules by different Resource Area - Wall/Floor/Roof/Field/Stair/MEP</p>
                    </div>
