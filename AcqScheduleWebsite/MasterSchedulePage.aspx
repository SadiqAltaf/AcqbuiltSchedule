<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterSchedulePage.aspx.cs" Inherits="MasterSchedulePage" Async="true" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="jombotron text-center">
                <h1> 
                    ACQBUILT MASTER SCHEDULE</h1>
                <p> Select Date to Load Schedule</p>
            </div>
        </div>
        ...
        <div class="container">
            ...
            Address
            <br />
            <asp:TextBox ID="TextBox2" runat="server" Height="51px" Width="329px"></asp:TextBox>
            <br />
            Stage<br />
            ...
            <br />
            Comment<br />
            <asp:TextBox ID="TextBox8" runat="server" Height="44px"></asp:TextBox>
            <br />
            <br />
